...
const Timeline = () => {
  ...
  return (
    <div className="relative px-6 sm:px-6 py-12">
      {/* Vertical Line */}
      <div className="absolute left-6 md:left-1/2 transform md:-translate-x-1/2 h-full w-1 bg-blue-200 z-0"></div>
      ...
      <div className="space-y-12">
        {timelineData.map((milestone, index) => (
          ...
          >
            {/* Content Card */}
            <div
              className={`w-full md:w-[1000px] mb-4 md:mb-0 flex ${
                index % 2 === 0
            ...
            {/* Dot */}
            <div
              className="absolute top-1 left-6 md:left-1/2 md:transform md:-translate-x-1/2 
